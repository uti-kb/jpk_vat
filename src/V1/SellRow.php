...
class SellRow implements XmlSerializable, XmlDeserializable
{
    ...
    public function xmlSerialize(Writer $writer)
    {
        ...
        $writer->write([
            ...
            'NrDokumentu'       => $this->id,
            'NazwaNabywcy'      => $this->name ?: 'brak',
            'AdresNabywcy'      => $this->address ?: 'brak'
        ]);
    ...
    public static function xmlDeserialize(Reader $reader)
    {
        ...
        $object->name       = $keyValue[Schema::NS.'NazwaNabywcy'];
        $object->address    = $keyValue[Schema::NS.'AdresNabywcy'];
        $object->id         = $keyValue[Schema::NS.'NrDokumentu'];
